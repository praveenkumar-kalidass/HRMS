...
<body>
    ...
    <div class="banner">
        ...
        <div class="banner-text">
            <div class="bnr-title wow zoomIn animated" data-wow-delay=".5s"><img src="images/logo1.png" width="40%" alt="" />
            </div>
            ...
            <div class="social-icons wow slideInUp animated" data-wow-delay=".9s">
                <ul>
                    <li>
                        <a href="http://www.ideas2it.com/" class="ideas"></a>
                    </li>
                    <li>
                        <a href="https://www.facebook.com/Ideas2itTechnologies/"> </a>
                    </li>
                    <li>
                        <a href="https://www.linkedin.com/company/ideas2it" class="in"> </a>
                    </li>
                    <li>
                        <a href="https://twitter.com/ideas2it" class="twi"> </a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    onsubmit="saveUsername(this);return validateForm(this)" class="cd-form" autocomplete="off">
                <h2 class="form-signin-heading">
                       <fmt:message key="login.heading"/>
                </h2>
                    <p class="fieldset">
                    	<label class="image-replace cd-email" for="signin-email">Username</label>                        
                        <input type="text" name="j_username" id="j_username" class="full-width has-padding has-border"
           placeholder="<fmt:message key="label.username"/>" required tabindex="1">
                    ...
                    <p class="fieldset">                
                        ...
                        <input type="password" class="full-width has-padding has-border" name="j_password" id="signin-password" tabindex="2"
           placeholder="<fmt:message key="label.password"/>" required>
                    ...
                    <c:if test="${appConfig['rememberMeEnabled']}">
                     <input type="checkbox" name="_spring_security_remember_me" id="remember-me"tabindex="3"/>
            ...
            <div id="cd-reset-password">
                ...
                <p class="cd-form-bottom-message"><a href="#0">Back to log-in</a>
                </p>
            </div>
            <!-- cd-reset-password -->
            <a href="#0" class="cd-close-form">Close</a>
