                        ...
                        <div id="User-Table" role="tabpanel" class="tab-pane active">
                            <div class="form">
                                <div class="main-head">
                                    ...
                                    <div id="chartContainer" style="float: left; margin-bottom: 10px; height: 400px; width: 100%;">
                                    </div>
            ...
            window.onload = function() {
                var chart = new CanvasJS.Chart("chartContainer", {
                    ...
                    data: [{
                        ...
                        markerType: "square",
                        color: "#F08080",
                        dataPoints: [ < c: forEach
                            var = "attendance"
                            items = "${AttendanceList}" > {
                                x: new Date(new Date("${attendance.date}").getFullYear(), new Date("${attendance.date}").getMonth(), new Date("${attendance.date}").getDate()),
                                y: new Date("Jan 1, 2000 ${attendance.timeOut}").getHours()
                            }, < /c:forEach>
                        ]
                    }, {
                        type: "line",
                        ...
                        dataPoints: [ < c: forEach
                            ...
                            items = "${AttendanceList}" > {
                                x: new Date(new Date("${attendance.date}").getFullYear(), new Date("${attendance.date}").getMonth(), new Date("${attendance.date}").getDate()),
                                y: new Date("Jan 1, 2000 ${attendance.timeIn}").getHours()
                            }, < /c:forEach>
                        ]
                    }],
                    legend: {
