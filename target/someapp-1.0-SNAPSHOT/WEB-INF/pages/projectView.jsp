                            ...
                            <c:forEach items="${TeamList}" var="team">
                                ...
                                <div class="col-md-12" style="padding-top:10px;">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label for="example-text-input" class="col-md-6">
                                            <c:set value="${team.user}" var="user" />
                                            <a href="user_view.html?id=<c:out value='${user.id} ' />">   <c:out value='${user.firstName}' /> &nbsp;
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <select name="desigantion" required="required" class="form-control" id="designationView" onchange="loadUser();">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <spring:select path="user.id" class="form-control" id="userView" required="required">
