                                                    ...
                                                    <thead>
                                                        <tr>
                                                            <th class="price-top first" onclick="sort_table(people, 0, asc1); asc1 *= -1; asc4 = 1; asc3 = 1; asc2 = 1;">
                                                                <div class="fil-name">Role Id</div>
                                                            ...
                                                            <th class="price-top last" onclick="sort_table(people, 1, asc2); asc2 *= -1; asc4 = 1; asc3 = 1; asc1 = 1;">
                                                                <div class="fil-name">Role Name</div>
                                                                <div class="fil-ico"><span class="arrow-up"></span><span class="arrow-space"></span><span class="arrow-down"></span> </div>
                                                            </th>
                                ...
                                <c:if test="${RoleEdit!=null}">
                                    <spring:form action="role_update" method="post" class="form-group" modelAttribute="RoleEdit">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group row">
                                                <label for="example-text-input" class="col-md-4 col-form-label">Role Id</label>
                                                <div class="col-md-8">
                                                    <spring:input path="roleId" class="form-control" id="example-text-input" placeHolder="Role Id" readonly="readOnly" /> </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-text-input" class="col-md-4 col-form-label">Role Name</label>
                                                <div class="col-md-8">
