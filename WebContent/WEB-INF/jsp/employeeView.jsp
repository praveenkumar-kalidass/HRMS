            ...
            <div class="content-main">
                <div class="col-md-12">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li role="presentation"><a href="#Communication-Details" aria-controls="Department-Table" role="tab" data-toggle="tab">Communication Details</a>
                        </li>
                        <li role="presentation"><a href="#Education-Details" aria-controls="Department-Table" role="tab" data-toggle="tab">Education Details</a>
                        </li>
                        <li role="presentation"><a href="#Certification-Details" aria-controls="Department-Table" role="tab" data-toggle="tab">Certification Details</a>
                        </li>
                    </ul>
                    <div class="tab-content">
                        <div id="Personal-Details" role="tabpanel" class="tab-pane active">
                            <div class="main-head">
                                <h1 class="title" style="float:left; width:80%;"> Personal Details </h1>
                                <a href="personal_edit.html?id=<c:out value='${employee.employeeId}' />" style="float:right;width:20%; padding-top: 26px;" class="edit"> <i class="fa fa-pencil"></i> Edit Personal Details </a>
                            </div>
                            ...
                            <div class="form">
                                <div class="col-md-12">
                                    <div class="col-md-4">
                                        <div class="col-md-12">
                                            <img src="upload/<c:out value='${employee.employeePicture}' />" width="250" height="300" />
                                        </div>
                                        <div class="col-md-12" style="padding-top: 10px; margin-left:65px;">
                                            <a href="picture_edit.html?id=<c:out value='${employee.employeeId}' />" class="edit">
                                                <button class="btn btn-info"> <i class="fa fa-pencil"></i> Edit Picture </button>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label for="example-text-input" class="col-md-6">
                                                <c:out value='${department.departmentName}' /> </label>
                                        </div>

                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-md-6 col-form-label"> Designation</label>
                                            <label for="example-text-input" class="col-md-6">
                                                <c:out value='${designation.designationName}' /> </label>
                                        </div>

                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-md-6 col-form-label"> Account Number </label>
                                            <label for="example-text-input" class="col-md-6">
                                                <c:out value='${employee.employeeBankAccountNumber}' /> </label>
                                        </div>

                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-md-6 col-form-label"> User Name</label>
                                            <label for="example-text-input" class="col-md-6">
                                                <c:out value='${employee.employeeUserName}' /> </label>
                                        </div>

                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-md-6 col-form-label"> Role </label>
                                            <label for="example-text-input" class="col-md-6">
                                                <c:set value='${employee.employeeRole}' var="role" />
                                                <c:out value='${role.roleName}' /> </label>
                                        </div>
                                ...
                                <c:forEach items="${AddressList}" var="address">
                                    ...
                                    <div class="col-md-6">
                                        <div class="col-md-12" style="margin:0px; padding:0px;">
                                            <h5 class="title" style="float:left; width:80%;"> <c:out value='${address.addressType}' />  Details </h5>
                                            <a href="address_edit.html?id=<c:out value='${address.addressId}' />" style="float:right;width:20%; padding-top: 5px;" class="edit"> <i class="fa fa-pencil"></i> Edit </a>
                                            <div class="col-md-12" style="margin:0px; padding:0px;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label for="example-text-input" class="col-md-6">
                                                <c:out value='${address.country}' /> </label>
                                        </div>
                        ...
                        <div id="Education-Details" role="tabpanel" class="tab-pane">
                            ...
                            <c:forEach items="${EducationList}" var="education">
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-12" style="margin:0px; padding:0px;">
                                        <h5 class="title" style="float:left; width:80%;"> <c:out value='${education.type}' />  Details </h5>
                                        <a href="education_edit.html?id=<c:out value='${education.educationId}' />" style="float:right;width:20%; padding-top: 5px;" class="edit"> <i class="fa fa-pencil"></i> Edit </a>
                                        <div class="col-md-12" style="margin:0px; padding:0px;">
                                            <hr style="margin-top:5px; ">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label for="example-text-input" class="col-md-6">
                                            <c:out value='${education.institution}' /> </label>
                                    </div>
                        ...
                        <div id="Certification-Details" role="tabpanel" class="tab-pane">
                            ...
                            <c:if test="${CertificationList!=null}">
                                <c:forEach items="${CertificationList}" var="certification">
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-12" style="margin:0px; padding:0px;">
                                            <h5 class="title" style="float:left; width:80%;"> <c:out value='${certification.courseName}' />  Details </h5>
                                            <a href="certification_edit.html?id=<c:out value='${certification.certificationId}' />" style="float:right;width:20%; padding-top: 5px;" class="edit"> <i class="fa fa-pencil"></i> Edit </a>
                                            <div class="col-md-12" style="margin:0px; padding:0px;">
                                                <hr style="margin-top:5px; ">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-md-6 col-form-label"> Course Name </label>
                                            <label for="example-text-input" class="col-md-6">
                                                <c:out value='${certification.courseName}' /> </label>
                                        </div>

                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-md-6 col-form-label"> From Date </label>
                                            <label for="example-text-input" class="col-md-6">
                                                <c:out value='${certification.fromDate}' /> </label>
                                        </div>

                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-md-6 col-form-label"> To Date </label>
                                            <label for="example-text-input" class="col-md-6">
                                                <c:out value='${certification.toDate}' /> </label>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-md-6 col-form-label"> Institute Name </label>
                                            <label for="example-text-input" class="col-md-6">
                                                <c:out value='${certification.institution}' /> </label>
                                        </div>
                    ...
                    <c:if test="${CertificateEdit!=null}">
                        <spring:form action="certification_update" method="post" class="form-group" modelAttribute="CertificateEdit" enctype="multipart/form-data">
                            <div class="col-md-12">
                                ...
                                <spring:input path="employee.employeeId" type="hidden"  class="form-control" id="example-text-input" placeHolder="Department Id" readonly="readOnly" />
                                 ...
                                 <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                             <div class="input-group date form_date col-md-12" data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input1" data-link-format="yyyy-mm-dd">
             								       <input class="form-control" size="16" type="text" value="<c:out value='${CertificateEdit.fromDate}' />" readonly>            										      
   ...
   <div id="education_model" class="modal fade" role="dialog" aria-hidden="false" data-backdrop="static">
                    ...
                    <c:if test="${EducationEdit!=null}">
                        <spring:form action="education_update" method="post" class="form-group" modelAttribute="EducationEdit" enctype="multipart/form-data">
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-md-4 col-form-label">Degree & Course Name <br> Ex : BE(CSE)</label>
                                    <div class="col-md-8">
    ...
    <div id="picture_model" class="modal fade" role="dialog" aria-hidden="false" data-backdrop="static">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Update Picture</h4> </div>
                <div class="modal-body">
                    <c:if test="${PictureEdit!=null}">
                        <spring:form action="picture_update" method="post" class="form-group" modelAttribute="PictureEdit" enctype="multipart/form-data">
                            <div class="col-md-12">
                                ...
                                <spring:input path="employeeId" type="hidden" class="form-control" id="example-text-input" placeHolder="Department Id" readonly="readOnly" />

                                <div class="form-group row">
                                    <label for="example-text-input" class="col-md-4 col-form-label">New Picture</label>
                                    <div class="col-md-8">
                                        <spring:input path="employeePicture" class="form-control" type="file" placeHolder="Select Image" /> </div>
                                </div>
    ...
    <div id="personal_model" class="modal fade" role="dialog" aria-hidden="false" data-backdrop="static">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Edit Personal Details</h4> </div>
                <div class="modal-body">
                    <c:if test="${PersonalEdit!=null}">
                        <spring:form action="personal_update" method="post" class="form-group" modelAttribute="PersonalEdit">
                            <div class="col-md-12">
                                ...
                                <spring:input path="employeeId" type="hidden" class="form-control" id="example-text-input" readonly="readOnly" />
                                <spring:input path="employeePicture" type="hidden" class="form-control" id="example-text-input" readonly="readOnly" />

                                <div class="form-group row">
                                    <label for="example-text-input" class="col-md-4 col-form-label">First Name</label>
                                    <div class="col-md-8">
                                        <spring:input path="employeeFirstName" class="form-control" placeHolder="First Name" /> </div>
                                </div>
                                
                                 <div class="form-group row">
                                    <label for="example-text-input" class="col-md-4 col-form-label">Last Name</label>
                                    <div class="col-md-8">
                                        <spring:input path="employeeLastName" class="form-control" placeHolder="First Name" /> </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group date form_date col-md-12" data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                                            <input class="form-control" size="16" type="text" value="<c:out value='${PersonalEdit.employeeDateOfBirth}' />" readonly>
                                            <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <div class="input-group date form_date col-md-12" data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input3" data-link-format="yyyy-mm-dd">
                                                <input class="form-control" size="16" type="text" value="<c:out value='${PersonalEdit.employeeDateOfJoining}' />" readonly>
                                                <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                            </div>
                                            <spring:input path="employeeDateOfJoining" id="dtp_input3" type="hidden" class="form-control" placeHolder="Date of Joining" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-md-4 col-form-label">User Name</label>
                                        <div class="col-md-8">
