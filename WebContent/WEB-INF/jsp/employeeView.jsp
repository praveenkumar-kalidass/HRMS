                        ...
                        <div id="Personal-Details" role="tabpanel" class="tab-pane active">
                            <div class="main-head">
                                <h1 class="title" style="float: left; width: 80%;">
									Personal Details</h1>
                                <a href="personal_edit.html?id=<c:out value='${employee.employeeId}' />" style="float: right; width: 20%; padding-top: 26px;" class="edit"> <i class="fa fa-pencil"></i> Edit Personal Details
                                </a>
                            </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label for="example-text-input" class="col-md-6">
                                                <c:out value='${employee.employeeDateOfBirth}' />
                                            </label>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label for="example-text-input" class="col-md-6">
                                                <c:out value='${employee.employeeGender}' />
                                            </label>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label for="example-text-input" class="col-md-6">
                                                <c:out value='${employee.employeeMaritalStatus}' />
                                            </label>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label for="example-text-input" class="col-md-6">
                                                <c:out value='${employee.employeeDateOfJoining}' />
                                            </label>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label for="example-text-input" class="col-md-6">
                                                <c:out value='${employee.employeeBankAccountNumber}' />
                                            </label>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label for="example-text-input" class="col-md-6">
                                                <c:out value='${employee.employeeUserName}' />
                                            </label>
                                        </div>
                        ...
                        <spring:form action="personal_update" method="post" class="form-group" modelAttribute="PersonalEdit">
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group date form_date col-md-12" data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                                            <input class="form-control" size="16" type="text" value="<c:out value='${PersonalEdit.employeeDateOfBirth}' />" readonly> <span class="input-group-addon"><span
												class="fa fa-calendar"></span></span>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <div class="input-group date form_date col-md-12" data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input3" data-link-format="yyyy-mm-dd">
                                                <input class="form-control" size="16" type="text" value="<c:out value='${PersonalEdit.employeeDateOfJoining}' />" readonly> <span class="input-group-addon"><span
												class="fa fa-calendar"></span></span>
                                            </div>
