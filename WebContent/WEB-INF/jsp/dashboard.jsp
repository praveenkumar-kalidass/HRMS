    ...
    <div class="containe">
        ...
        <div class="content-bar">
            ...
            <div class="content-main">
                ...
                <div class="wow fadeInUp animated" data-wow-delay="1s" id="columnchartContainer" style="height: 300px; width: 45%; float: left; margin-top: 10px; margin-left: 20px; margin-right: 20px; border: 2px solid #3184D5; border-radius: 5px;">
                </div>

                <div class="wow fadeInUp animated" data-wow-delay="1s" id="chartContainer" style="height: 300px; width: 45%; float: right; margin-top: 10px; margin-left: 20px; margin-right: 20px; border: 2px solid #3184D5; border-radius: 5px;">
                </div>
