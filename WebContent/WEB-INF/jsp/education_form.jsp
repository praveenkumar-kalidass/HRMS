 ...
 <%@ taglib uri="http://www.springframework.org/tags/form" prefix="spring" %>
                               ...
                               <spring:form method="post" action="education_insert"  modelAttribute="Employee" class="form-group" >
                               
                               <c:forEach items="${Employee.education}" var="certification" varStatus="status">
                               ...
                               <div class="col-md-8" style="padding-top:50px;">
                                ...
                                <c:if test="${status.index==3}">
                                  ...
                                  <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                           <spring:input path="education[${status.index}].employee.employeeId" type="hidden" class="form-control" value="${Employee.employeeId}"  />
                                            <c:if test="${status.index==0}">
                                     ...
                                     <div class="form-group row">
                                        ...
                                        <c:if test="${status.index==2}">
                                        Degree & Course Name <br> Ex : BE(CSE)
                                        </c:if>
                                        <c:if test="${status.index==3}">
                                        Degree & Course Name <br> Ex : ME(CSE)
                                        </c:if>
