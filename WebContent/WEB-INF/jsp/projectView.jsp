...
<body>
				...
				<div class="col-md-12">
					...
					<ul class="nav nav-tabs" role="tablist">
						<li role="presentation" class="active"><a
							href="#Project-Details" aria-controls="Department-Table"
							role="tab" data-toggle="tab">Project Details</a></li>
						<li role="presentation"><a href="#Client-Details"
							aria-controls="Department-Table" role="tab" data-toggle="tab">Client
								Details</a></li>
						<li role="presentation"><a href="#Release-Details"
							aria-controls="Department-Table" role="tab" data-toggle="tab">Release
								Details</a></li>
						<li role="presentation"><a href="#Team-Details"
							aria-controls="Department-Table" role="tab" data-toggle="tab">Team
								Details</a></li>
					</ul>
					<div class="tab-content">
						<div id="Project-Details" role="tabpanel" class="tab-pane active">
							<div class="main-head">
								...
								<a
									href="project_edit.html?id=<c:out value='${project.projectId}' />"
									style="float: right; width: 20%; padding-top: 26px;"
									class="edit"> <i class="fa fa-pencil"></i> Edit Project
									Details
								</a>
								</c:if>
							</div>
									...
									<div class="col-md-12">
										...
										<div class="form-group row">
											<label for="example-text-input"
												class="col-md-6 col-form-label"> Project Id </label> <label
										...
										<div class="form-group row">
											<label for="example-text-input"
												class="col-md-6 col-form-label"> Project Name </label> <label
												for="example-text-input" class="col-md-6"> <c:out
										...
										<div class="form-group row">
											<label for="example-text-input"
												class="col-md-6 col-form-label"> Date of Starting </label> <label
												for="example-text-input" class="col-md-6"> <c:out
										...
										<div class="form-group row">
											<label for="example-text-input"
												class="col-md-6 col-form-label"> Description </label> <label
												for="example-text-input" class="col-md-6"> <c:out
										...
										<div class="form-group row">
											<label for="example-text-input"
												class="col-md-6 col-form-label"> Status </label> <label
												for="example-text-input" class="col-md-6"> <c:out
						...
						<div id="Client-Details" role="tabpanel" class="tab-pane">
							...
							<div class="col-md-12">
										...
										<div class="form-group row">
											<label for="example-text-input"
												class="col-md-6 col-form-label"> Name </label> <label
												for="example-text-input" class="col-md-6"> <c:out
										...
										<div class="form-group row">
											<label for="example-text-input"
												class="col-md-6 col-form-label"> Web Address </label> <label
												for="example-text-input" class="col-md-6"> <c:out
						...
						<div id="Release-Details" role="tabpanel" class="tab-pane">
							<div class="main-head">
								...
								<a
									...
									style="float: right; width: 20%; padding-top: 26px;"
									class="edit"> <i class="fa fa-plus-circle"></i> Add New Release
									Details
								</a>
								</c:if>
							</div>
								...
								<div class="col-md-12" style="padding-top:10px;">
									<div class="col-md-12" style="margin: 0px; padding: 0px;">
										...
										<a
											...
											class="delete"> <i class="fa fa-trash"></i> Delete 
										</a>
										<a
											href="projectRelease_edit.html?id=<c:out value='${release.releaseId}' />"
											style="float: right; width: 10%; padding-top: 5px;"
									...
									<div class="form-group row">
										<label for="example-text-input"
											class="col-md-6 col-form-label"> Version Name </label> <label
											for="example-text-input" class="col-md-6"> <c:out
									...
									<div class="form-group row">
										<label for="example-text-input"
											class="col-md-6 col-form-label"> Release Date </label> <label
											for="example-text-input" class="col-md-6"> <c:out
	...
	<div id="project_model" class="modal fade" role="dialog"
						...
						.dialog(
								{
									...
									buttons : {
										Ok : function() {
											$(this).dialog("close");
											window.location = "project_view.html?id="
