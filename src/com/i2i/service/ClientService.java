...
ClientDao clientDao = new ClientDao();
    ...
    /**
     * <p>
     * This method Passes the values to its dao class to update the existing client in the database.
     * </p>
     * 
     * @param client
     *       model object that stores the client data associated with model.
    ...
    /**
     * <p>
     * This method checks the presence of client ID in the database.
    ...
    /**
     * <p>
     * This method passes the client ID to its dao class to search in the database.
     * Returns the model object of the client to its controller to display.
     * </p>
     *
     * @param clientId
     *       contains the ID of the client.
     * @return object
     *       gives the appropriate client object for the corresponding client ID.
     * @throws DataException
    ...
    /**
     * <p>
     * This method retrieves the Client data from the records and returns the list of data to display.
     * </p>
     * 
     * @return list
     *       Gives the list of client details retrieved from the database.
     * @throws DataException
