...
/**
 * <p>
 * Service class which does validations with the user input of attendance details.
...
public class AttendanceService {
    ...
    /**
     * <p>
     * This method checks the presence of attendance ID in the database.
    ...
    /**
     * <p>
     * This method passes the attendance ID to its dao class to search in the database.
     * Returns the model object of the attendance to its controller to display.
     * </p>
     *
     * @param attendanceId
     *       contains the ID of the attendance.
     *       
     * @return object
     *       gives the appropriate attendance object for the corresponding attendance ID.
     * @throws DataException
    ...
    /**
     * <p>
     * This method retrieves the Attendance data from the records and returns the list of data to display.
     * </p>
     * 
     * @return list
     *       Gives the list of attendance details retrieved from the database.
     * @throws DataException
