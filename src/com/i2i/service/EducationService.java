...
/**
 * <p>
 * Service class which does validations with the user input of education details.
...
EducationDao educationtDao = new EducationDao();
    ...
    /**
     * <p>
     * This method checks the presence of education ID in the database.
     * Passes the value to its dao class to insert if not present. 
     * </p>
     * 
     * @param education
     *       model object that stores the education data associated with model.
     * @return boolean
     ...
     * Returns the model object of the education to its controller to display.
     * </p>
     *
     * @param educationId
     ...
     *       
     * @return education
     *       gives the appropriate education object for the corresponding educationID.
     * @throws DataException
    ...
    /**
     * <p>
     * This method retrieves the Education data from the records and returns the list of data to display.
     * </p>
     * 
     * @return list
     *       Gives the list of education details retrieved from the database.
     * @throws DataException
    ...
    /**
     * <p>
     * This method retrieves the Education data for given department from the records and returns the list of data to display.
     * </p>
     * @param departmentId
     *       contains the ID of the department. 
     * @return list
     *       Gives the list of education details for given departmentId retrieved from the database.
     * @throws DataException
     *       throws error message if problem arises with retrieving list of data from the database.
     */
