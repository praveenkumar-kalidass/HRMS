...
/**
 * <p>
 * Service class which does validations with the user input of leaveRequest details.
...
public class LeaveRequestService {
    ...
    /**
     * <p>
     * This method passes the leaveRequest ID to its dao class to search in the database.
     * Returns the model object of the leaveRequest to its controller to display.
     * </p>
     *
     * @param leaveRequestId
     *       contains the ID of the leaveRequest.
     *       
     * @return object
     *       gives the appropriate leaveRequest object for the corresponding leaveRequest ID.
     * @throws DataException
    ...
    /**
     * <p>
     * This method retrieves the LeaveRequest data from the records and returns the list of data to display.
     * </p>
     * 
     * @return list
     *       Gives the list of leaveRequest details retrieved from the database.
     * @throws DataException
