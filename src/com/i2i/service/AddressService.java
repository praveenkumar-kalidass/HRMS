...
public class AddressService {
    ...
    /**
     * <p>
     * This method checks the presence of address ID in the database.
     * Passes the value to its dao class to insert if not present. 
     * </p>
     * 
     * @param address
     *       model object that stores the address data associated with model.
     * @return boolean
    ...
    /**
     * <p>
     * This method passes the address ID to its dao class to search in the database.
     * Returns the model object of the address to its controller to display.
     * </p>
     *
     * @param addressId
     *       contains the ID of the address.
     *       
     * @return object
     *       gives the appropriate address object for the corresponding address ID.
     * @throws DataException
    ...
    /**
     * <p>
     * This method retrieves the Address data from the records and returns the list of data to display.
     * </p>
     * 
     * @return list
     *       Gives the list of address details retrieved from the database.
     * @throws DataException
