...
/**
 * <p>
 * Service class which does validations with the user input of certification details.
...
CertificationDao certificationtDao = new CertificationDao();
     ...
     * 
     * @param certification
     *       model object that stores the certification data associated with model.
     * @return boolean
     ...
     * Returns the model object of the certification to its controller to display.
     * </p>
     *
     ...
     *       gives the appropriate certification object for the corresponding certificationID.
     * @throws DataException
    ...
    /**
     * <p>
     * This method retrieves the Certification data from the records and returns the list of data to display.
     * </p>
     * 
     * @return list
     *       Gives the list of certification details retrieved from the database.
     * @throws DataException
    ...
    /**
     * <p>
     * This method retrieves the Certification data for given department from the records and returns the list of data to display.
     * </p>
     * @param departmentId
     *       contains the ID of the department. 
     * @return list
     *       Gives the list of certification details for given departmentId retrieved from the database.
     * @throws DataException
     *       throws error message if problem arises with retrieving list of data from the database.
     */
