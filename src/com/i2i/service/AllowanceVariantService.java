...
import com.i2i.dao.AllowanceVariantDao;
import com.i2i.exception.DataException;
import com.i2i.model.AllowanceVariant;

/**
 * <p>
 * Service class which does validations with the user input of Allowance details.
 ...
 * @created 2016-09-15
 */
public class AllowanceVariantService {
    AllowanceVariantDao allowanceVarianttDao = new AllowanceVariantDao();

    /**
     * <p>
     * This method checks the presence of allowanceVariant ID in the database. Passes
     ...
     * database. Returns the model object of the allowanceVariant to its controller
     * to display.
     * </p>
     *
     * @param allowanceVariantId
     *            contains the ID of the allowanceVariant.
     * 
     * @return allowanceVariant gives the appropriate allowanceVariant object for the
     *         corresponding allowanceVariantID.
     * @throws DataException
     ...
     * </p>
     * 
     * @return list Gives the list of allowanceVariant details retrieved from the
     *         database.
     * @throws DataException
    ...
    /**
     * <p>
     * This method retrieves the AllowanceVariant data for given designation from the
     * records and returns the list of data to display.
     * </p>
     * 
     * @param designationId
     *            contains the ID of the designation.
     * @return list Gives the list of allowanceVariant details for given designationId
