...
/**
 * <p>
 * Service class which does validations with the user input of designation details.
...
public class DesignationService {
     ...
     * Returns the model object of the designation to its controller to display.
     * </p>
     *
     * @param designationId
     *       contains the ID of the designation.
     *       
     * @return designation
     *       gives the appropriate designation object for the corresponding designationID.
     * @throws DataException
    ...
    /**
     * <p>
     * This method retrieves the Designation data from the records and returns the list of data to display.
     * </p>
     * 
     * @return list
     *       Gives the list of designation details retrieved from the database.
     * @throws DataException
    ...
    /**
     * <p>
     * This method retrieves the Designation data for given department from the records and returns the list of data to display.
     * </p>
     * @param departmentId
     *       contains the ID of the department. 
     * @return list
     *       Gives the list of designation details for given departmentId retrieved from the database.
     * @throws DataException
     *       throws error message if problem arises with retrieving list of data from the database.
     */
