...
public class AttendanceDao {
    ...
    public boolean modifyAttendance(Attendance attendance) throws DataException {
        ...
        try {
            ...
            throw new DataException("Error while Updating Attendance ID : " + attendance.getAttendanceId());
        } finally {
            session.close();
        }
    }
    ...
    /**
     * <p>
     * This method retrieves the top attendance data from the records and returns
     * the list of data.
     * </p>
     * 
     * @return list Gives the list of attendance details stored in the database.
    ...
    public List<Attendance> retrieveAttendancesByEmployeeId(int employeeId) throws DataException {
        ...
        try {
            ...
            FileUtil.errorLogger("Exception in retrieveAttendancesByEmployeeId() : " + exception.getMessage());
            throw new DataException("Error while displaying Single Attendances By Given Employee");
        } finally {
            session.close();
        }
    }
    ...
    public List<Attendance> retrieveCompleteAttendanceByEmployeeId(int employeeId) throws DataException {
        ...
        try {
            ...
            FileUtil.errorLogger("Exception in retrieveCompleteAttendanceByEmployeeId() : " + exception.getMessage());
            throw new DataException("Error while displaying all Attendances fro given Employee");
        } finally {
            session.close();
        }
    }
