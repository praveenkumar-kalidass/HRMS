...
public class AllowanceVariantDao {
    ...
    public AllowanceVariant findAllowanceVariantById(int allowanceVariantId) throws DataException {
        ...
        try {
            ...
            throw new DataException("Error while searching Allowance Varient By its ID : " + allowanceVariantId);
        } finally {
            session.close();
        }
    }
    ...
    public List<AllowanceVariant> retrieveAllowanceVariants() throws DataException {
        ...
        try {
            ...
            throw new DataException("Error while displaying all Allowance Varient");
        } finally {
            session.close();
        }
    }
    ...
    public AllowanceVariant retrieveAllowanceVariantByDesignation(int designationId) throws DataException {
        ...
        try {
            ...
            throw new DataException("Error while displaying all Allowance varience for Designation");
        } finally {
            session.close();
        }
    }
