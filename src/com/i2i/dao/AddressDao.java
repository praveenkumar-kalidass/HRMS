...
public class AddressDao {
    ...
    public List<Address> retrieveAddressByEmployee(int employeeId) throws DataException {
        ...
        try {
            ...
            FileUtil.errorLogger("Exception in retrieveAddressByEmployee() : " + exception.getMessage());
            throw new DataException("Error while displaying all Retriving Address for this employee");
        } finally {
            session.close();
        }
    }
