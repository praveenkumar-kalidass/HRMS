 ...
 * performs operation on manipulation of records associated with Employee Addresss.
 * </p>
 *
 * @author Praveenkumar
 *
...
public class AddressDao {
    ...
    /**
     * <p>
     * This method opens a new session and Inserts the model object of the address into the database.
     * </p>
     * 
     * @param address
     *       model object that stores the address data associated with model class.
     * @return true
     ...
     *       contains the ID of the address.
     * @return object
     *       gives the appropriate address detail for the corresponding address ID.
     * @throws DataException
    ...
    /**
    * <p>
    * This method retrieves the address data from the records and returns the list of data.
    * </p>
    * 
    * @return list
    *       Gives the list of address details stored in the database.
    * @throws DataException
