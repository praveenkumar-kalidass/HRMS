 ...
 * is used to insert, update and delete education detail(s) for the employee
...
public class EducationDao {
	...
	/**
	 * * <p>
	 * Method is used to insert new Education
     * create a new session and Inserts the model object of the Education into the database.
     * </p>
	 * @param education
	 *      model object that stores the Education data associated with model class.
	...
	public boolean insertEducation(Education education) throws DataException {
		...
		try {
	        ...
	        throw new DataException("Error Occured while Inserting this" + education.getQualification() + " : please verify your details... Any try again..!");
		} finally {
			session.close();
		}
	}
     ...
     * create a new session and update the model object of the education from the database.
     * </p>
	 * @param education
	 *      model object that stores the education data associated with model class.
	 * @throws DataException
	...
	public boolean modifyEducation(Education education) throws DataException {
		...
		try {
	        ...
	        throw new DataException("Error Occured while Updating this" + education.getQualification() + " : please verify your details... Any try again..!");
		} finally {
			session.close();
		}
	}
	...
	/**
     * <p>
     * this method searches the education from the records using education ID and 
    ...
    /**
     * <p>
     * This method retrieves the education data from the records and returns the list of data.
     * </p>
     * 
     * @param educationId
     ...
     *       return the full list of education stored in database
     */
