...
public class EducationDao {
    ...
    public List<Education> retrieveEducationByEmployee(int employeeId) throws DataException {
        ...
        try {
            ...
            FileUtil.errorLogger("Exception in retrieveEducationByEmployee() : " + exception.getMessage());
            throw new DataException("Error while displaying all Education for Given Employee");
        } finally {
            session.close();
        }
    }
