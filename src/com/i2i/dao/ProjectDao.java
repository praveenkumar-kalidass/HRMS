...
public class ProjectDao {
    ...
    public boolean removeProject(Project project) throws DataException {
        ...
        try {
            ...
            throw new DataException("Error Occured while Remove this" + project.getProjectName()
                    + " : please verify your details... Any try again..!");
        } finally {
            session.close();
        }
    ...
    public Project findProjectById(int projectId) throws DataException {
        ...
        try {
            ...
            throw new DataException("Error while searching Project by given Id : " + projectId);
        } finally {
            session.close();
        }
    }
    ...
    public List<Project> retrieveProjectByClient(int clientId) throws DataException {
        ...
        try {
            ...
            throw new DataException("Error while displaying all Projects for given Client");
        } finally {
            session.close();
        }
    }
