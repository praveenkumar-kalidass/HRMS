...
public class ProjectController {
    ...
    /**
     * <p>
     * Mapping the request which required by user for client.html it will sent
     * the page and client list stored in database and model object to add new
     * client
     * </p>
     * 
     * @param model
    ...
    /**
     * <p>
     * This method passes the client detail as the model object into its Service
     * class.
     * </p>
     * 
     * @param client
    ...
    /**
     * <p>
     * Mapping the request which required by user for client_edit.html it will
     * sent the page and required client object stored in database for edit.
     * </p>
     * 
     * @param model
    ...
    /**
     * <p>
     * This method passes the Client id as the parameter object into its Service
    ...
    /**
     * <p>
     * Mapping the request which required by user for project.html it will sent
     * the page and project list stored in database and model object to add new
     * client
     * </p>
     * 
     * @param model
     *            ModelMap object used for setting Project model object, project
     *            list and Client List
     ...
     * 
     * @param clientId
     *            contains identity of the Client it is used to many to one map
     *            with project
     * @param project
    ...
    public String insertProject(@ModelAttribute("Project") Project project, BindingResult result, ModelMap model) {
        try {
    ...
    /**
     * <p>
     * Mapping the request which required by user for project_view.html it will
     * sent the page and required project object stored in database for edit.
     * </p>
     * 
     * @param model
    ...
    /**
     * <p>
     * Mapping the request which required by user for project_edit.html it will
     * sent the page and required project object stored in database for edit.
     * </p>
     * 
     * @param model
    ...
    /**
     * <p>
     * Mapping the request which required by user for projectRelease.html it
     * will sent the page and projectRelease list stored in database and model
     * object to add new project
     * </p>
     * 
     * @param model
     ...
     * 
     * @param projectId
     *            contains identity of the Project it is used to many to one map
     *            with projectRelease
    ...
    public String insertProjectRelease(@ModelAttribute("ProjectRelease") ProjectRelease projectRelease,
    ...
    /**
     * <p>
     * Mapping the request which required by user for projectRelease_edit.html
     * it will sent the page and required projectRelease object stored in
     * database for edit.
     * </p>
     * 
     * @param model
    ...
    public String updateProject(@ModelAttribute("ProjectReleaseEdit") ProjectRelease projectRelease,
            BindingResult result, ModelMap model) {
        try {
     ...
     * sent the page and team list stored in database and model object to add
     * new project
     * </p>
     * 
     * @param model
    ...
    /**
     * <p>
     * This method passes the team detail as the model object into its Service
     * class.
     * </p>
     * 
     * @param projectId
    ...
    public String insertTeam(@ModelAttribute("TeamAdd") Team team, BindingResult result, ModelMap model) {
        try {
            User user = userService.searchUser(team.getUser().getId());
            team.setUser(user);
            user.setTeam(team);
            if (teamService.addTeam(team)) {
                userService.updateUser(user);
                model.addAttribute("message", "User are successfully allocated");
                model.addAttribute("ProjectId", (team.getProject()).getProjectId());
            } else {
                model.addAttribute("message", "User details are not allocated");
            }
        } catch (DataException exception) {
            model.addAttribute("message", exception.getMessage());
        }
    ...
    /**
     * <p>
     * This method passes the team id as the parameter object into its Service
     * class for delete the record.
     * </p>
     * 
     * @param team
