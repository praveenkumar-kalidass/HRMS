...
public class UserController {
    ...
    /**
     * <p>
     * This method passes is used for AJAX to get the user list for the
     * given designation
     * </p>
     * 
     * @param designationId
     ...
     *            map with user
     * @param designationList
     *            model object that stores the user List data associated
     *            with model.
     * @return String returns the redirecting page url based on the appropriate
     *         operation.
     */
    ...
    public String deleteDesignation(@RequestParam("id") int designationId, ModelMap model) {
       ...
       /**
     * <p>
     * Mapping the request which required by user for user.html it will sent
     * the page and user list stored in database and model object to add new
     * department
     * </p>
     * 
     * @param model
    ...
    /**
     * <p>
     * This method passes the user id as the parameter object into its
     * Service class for delete the record.
     * </p>
     * 
     * @param roleId
     ...
     * @param model
     *            ModelMap object used for send message to the user the
    ...
    /**
     * <p>
     * This method passes the user personal details as the model object into
    ...
    public String addPersonalDetails(@ModelAttribute("User") User user, BindingResult result, ModelMap model) {
        try {
    ...
    /**
     * <p>
     * Mapping the request which required by user for userView.html it will
     * sent the page and required user object stored in database for edit.
     * </p>
     * 
     * @param model
    ...
    /**
     * <p>
     * This method passes the user detail as the model object into its
     * Service class.
     * </p>
     * 
     * @param user
    ...
    /**
     * <p>
     * This method passes the user Address details as the model object into
     * its Service class.
     * </p>
     * 
     * @param role
     *            model object that stores the user address data associated
     *            with model.
     * @return String returns the redirecting page url based on the appropriate
     *         operation.
     */
    ...
    /**
     * <p>
     * This method passes the user address detail as the model object into
     * its Service class.
     * </p>
     * 
     * @param user
     *            model object that modify the user address data associated
     *            with model.
     * @return String returns the redirecting page url based on the appropriate
     *         operation.
     */
    ...
    /**
     * <p>
     * This method passes the user certification detail as the model object
     * into its Service class.
     * </p>
     * 
     * @param user
    ...
    /**
     * <p>
     * This method passes the user education details as the model object
     * into its Service class.
     * </p>
     * 
     * @param role
     *            model object that stores the user education data
     *            associated with model.
     * @return String returns the redirecting page url based on the appropriate
     *         operation.
     */
    ...
    /**
     * <p>
     * This method passes the user education detail as the model object into
     * its Service class.
     * </p>
     * 
     * @param user
    ...
    /**
     * <p>
     * This method passes the user picture name detail as the model object
     * into its Service class. OutputStream and InputStream, FileUtil are used
     * to store the picture of the user in specific source
     * </p>
     * 
     * @param userPicture
    ...
    public String addPicture(@RequestParam("userPicture") MultipartFile profile,
            @RequestParam("userId") long userId, ModelMap map) {
    ...
    public String updatePicture(@RequestParam("userPicture") MultipartFile profile,
            @RequestParam("userId") long userId, ModelMap map) {
        InputStream inputStream = null;
        OutputStream outputStream = null;
