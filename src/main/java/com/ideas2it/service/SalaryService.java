...
/**
 * <p>
 * Service class which does generate the salary for each user. 
...
public class SalaryService {
    ...
    /**
     * Method is used genetare the salary for each user and return the salary list. 
     * 
     * @param fromDate
