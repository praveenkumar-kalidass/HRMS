...
public class ProjectReleaseServiceImpl extends GenericManagerImpl<ProjectRelease, Long>
		implements ProjectReleaseService {

	@Autowired
	ProjectReleaseDao projectReleaseDao;
