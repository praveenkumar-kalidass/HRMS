...
public class UserManagerImpl extends GenericManagerImpl<User, Long> implements UserManager, UserService {
     ...
     * @see com.ideas2it.service.MailEngine#sendMessage(org.springframework.mail.SimpleMailMessage, String, java.util.Map)
     */
    ...
    /**
	 * <p>
	 * This method checks the presence of user ID in the database. Passes
	 * the value to its dao class to insert if not present.
	 * </p>
	 * 
	 * @param user
	 *            model object that stores the user data associated with
	 *            model.
	 ...
	 *            contains the ID of the user.
	 * 
	 * @return object gives the appropriate user object for the
	...
	/**
	 * <p>
	 * This method retrieves the User data from the records and returns the
	 * list of data to display.
	 * </p>
	 * 
	 * @return list Gives the list of user details retrieved from the
	 *         database.
	 * @throws DataException
