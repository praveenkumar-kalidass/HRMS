...
public class Salary {
    ...
    public Salary(User user, float houseRentAllowance, float dearnessAllowance, float providentFund, float medicalAllowance, float totalAmount, float basicPay, int noDays, float lossOfPay){
    	this.user = user;
