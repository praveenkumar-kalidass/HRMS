...
public class UserDaoHibernate extends GenericDaoHibernate<User, Long> implements UserDao, UserDetailsService {
	...
	/**
	 * <p>
	 * This method opens a new session and deletes the user from the
	 * records.
	 * </p>
	 * 
	 * @param userId
	...
	/**
	 * <p>
	 * This method searches the user from the records using user ID and
	 * returns the data as a model object to display.
	 * </p>
	 * 
	 * @param departementId
	 *            contains the ID of the user.
	 * @return object gives the appropriate user detail for the
	...
	/**
	 * <p>
	 * This method retrieves the user data from the records and returns
	 * the list of data.
	 * </p>
	 * 
	 * @param designationId
	...
	public List<User> retrieveUserByDesignation(int designationId) throws DataException {
		...
		try {
			session = getSession();
            return session.createQuery("From User WHERE designation_id="+designationId+" AND id not in(select user.id from Team)").list();
