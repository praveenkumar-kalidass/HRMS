...
/**
    ...
    /**
     * <p>
     * This method retrieves the leaveRequest data for given user from the records and returns the list of data.
     * </p>
	 * @param userId
	 *            identity of the user
     * @return list
     *       Gives the list of leaveRequest details for given user stored in the database.
     * @throws DataException
     *       throws error message if problem arises with retrieving list of data from the database.
     */
    ...
    /**
     * <p>
     * This method retrieves the leaveRequest data for given user for given period from the records and returns the list of data.
     * </p>
	 * @param userId
	 *            identity of the user
	 * @param fromDate
     ...
     *       throws error message if problem arises with retrieving list of data from the database.
     */
    public List<LeaveRequest> calculateLeaveDaysForUser(long userId, String fromDate, String toDate) throws DataException {
    	Session session = null;
    	try {        	
    		session = getSession();
        	return session.createQuery("From LeaveRequest WHERE user_id=" + userId +" and from_date>='"+ fromDate +"' and to_date <='"+ toDate+"' and status='Approved'").list();
        } catch (HibernateException exception) {
            FileUtil.errorLogger("Exception in retrieveLeaveRequests() : " + exception.getMessage());
            throw new DataException("Error while displaying all LeaveRequests");
        } finally {
