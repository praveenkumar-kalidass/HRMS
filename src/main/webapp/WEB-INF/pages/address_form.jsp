    ...
    <%@ taglib uri="http://www.springframework.org/tags/form" prefix="spring" %>
        <c:if test="${same==1}">
            <div class="form-group row">
                ...
                <div class="col-md-8">
                    <textarea name="address[1].street" class="form-control" placeHolder="Address" readonly="readonly" data-validation="length" required="required" data-validation-length="min5" data-validation-error-msg="Please Enter the Valid Street Minimum 5 Characters">
                        <c:out value="${address}" />
                    </textarea>
                </div>
            </div>
