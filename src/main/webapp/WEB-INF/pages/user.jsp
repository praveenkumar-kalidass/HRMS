                                    ...
                                    <tbody>
                                        <c:forEach var="user" items="${UserList}">
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="user_view.html?id=<c:out value='${user.id} ' />" class="edit"> <c:out value="${user.firstName}"></c:out> &nbsp;<c:out value="${user.lastName}"></c:out> </a>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <a href="attendance_view.html?id=<c:out value='${user.id} ' />" > <i class="fa fa-edit"></i> View Attendance </a>
                                                </td>
                                                <td>
                                                    <a href="user_delete.html?id=<c:out value='${user.id} ' />" class="delete"> <i class="fa fa-trash"></i> Delete </a>
                                                </td>
