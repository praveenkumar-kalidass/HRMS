            ...
            <div class="content-main">
                <div class="col-md-12">
                    ...
                    <div id="Department-Table" role="tabpanel" class="tab-pane active">
                        ...
                        <div class="form">
                            <c:if test="${User!=null}">
                                <spring:form method="post" class="personal-form" modelAttribute="User" action="user_add" commandName="User">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <spring:input path="dateOfBirth" id="dtp_input2" type="hidden" class="form-control" placeHolder="Date of Birth" required="required" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <spring:input path="dateOfJoining" id="dtp_input3" type="hidden" class="form-control" />
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <spring:input path="bankAccountNumber" class="form-control" data-validation="number" data-validation-error-msg="Enter valid Account number" placeHolder="Account Number" required="required" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <spring:input path="username" id="userName" class="form-control" placeHolder="Username" onkeydown="userNameValid();"  onkeypress="userNameValid();" onchange="userNameValid();"  required="required" data-validation="length" data-validation-length="min6" data-validation-error-msg="Please Enter the Valid UserName Minimum 6 Characters" />
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <spring:input path="password" class="form-control" type="password" placeHolder="Password" required="required" data-validation="length" data-validation-length="min5" data-validation-error-msg="Please Enter the Strong Password Minimum 5 Characters" />
                                                </div>
                                            </div>
